...
Na płycię znajdę się gotowa do uruchomienia wersja gry oraz folder zawierający wszystkie pliki stworzone na potrzeby projektu. W folderze znajdzie się między innymi kod źródłowy oraz pliki blueprintów zawierające większość stworzonej logiki gry. Na przykład blueprinty interfejsu użytkownika, postaci, interaktywnych elementów środowiska czy dostępnych umiejętności. W plikach znajdują się również {\em level} na którym toczy się rozgrywka, modele, animacje oraz dźwięki wykorzystane w grze.
